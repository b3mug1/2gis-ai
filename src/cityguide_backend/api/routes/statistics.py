...
async def statistics(service: StatisticsService = Depends(get_statistics_service), current_user: UserProfile = Depends(get_current_user)) -> list[SearchStatisticsResponse]:
