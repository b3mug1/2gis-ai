...
class FavoritePlaceModel(Base):
    ...
    __table_args__ = (UniqueConstraint("user_id", "place_id", name="uq_favorite_places_user_place"),)
...
class SearchStatisticsModel(Base):
    ...
    __table_args__ = (UniqueConstraint("stat_date", "user_id", name="uq_search_statistics_date_user"),)
