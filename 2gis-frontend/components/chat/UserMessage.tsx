  ...
  return (
    <div className="flex items-end gap-2 max-w-[80%]">
      <div className="flex flex-col items-end gap-1">
        <div className="bg-gradient-to-br from-brand-500 to-brand-700 text-white px-4 py-2.5 rounded-2xl rounded-br-sm text-sm leading-relaxed shadow-sm shadow-brand-500/20">
          {message.content}
        </div>
