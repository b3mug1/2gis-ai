...
>(({ className, variant = "default", ...props }, ref) => (
  <ToastPrimitives.Root
    ...
    className={cn(
      ...
      variant === "default" && "glass border-[var(--glass-border)] text-foreground",
      variant === "destructive" && "border-destructive/30 bg-destructive/10 text-destructive dark:bg-destructive/20",
