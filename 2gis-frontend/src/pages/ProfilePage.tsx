...
function StatCard({
  ...
  return (
    <div className="rounded-2xl border border-[hsl(var(--border))] bg-card p-5 shadow-sm hover:border-[hsl(var(--primary)/0.4)] transition-all duration-200">
      <div className="w-9 h-9 rounded-xl bg-[hsl(var(--primary)/0.15)] text-[hsl(var(--primary))] flex items-center justify-center mb-3 font-bold">
    ...
    <div className="max-w-4xl mx-auto px-6 py-8 relative space-y-6">
      ...
      >
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 relative z-10">
          <div className="w-16 h-16 rounded-2xl bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] font-extrabold text-2xl flex items-center justify-center shrink-0 shadow-md">
        ...
        {histLoading ? (
          ...
          <div className="space-y-2">
            {history!.slice(0, 5).map((item) => (
              <div
                key={item.id}
                className="flex items-center gap-3 p-3 rounded-xl bg-muted/40 border border-[hsl(var(--border)/0.6)] hover:border-[hsl(var(--primary)/0.4)] transition-all"
              >
