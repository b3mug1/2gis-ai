        ...
        {popularPlaces.length > 0 && (
          <section className="py-10 sm:py-16">
            <div className="mb-6 flex items-end justify-between gap-4">
              ...
              <Link
                to="/chat?q=%D0%BF%D0%BE%D0%BF%D1%83%D0%BB%D1%8F%D1%80%D0%BD%D1%8B%D0%B5%20%D0%BC%D0%B5%D1%81%D1%82%D0%B0%20%D0%90%D1%81%D1%82%D0%B0%D0%BD%D0%B0"
        ...
        {recentSearches.length > 0 && (
          <section className="py-10 sm:py-16">
            <div className="mb-5 flex items-center justify-between gap-4">
              ...
              <Link to="/history" className="text-xs font-semibold text-[hsl(var(--primary))] hover:underline">
